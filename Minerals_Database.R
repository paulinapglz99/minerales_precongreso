...
#El primer paso es cargar la librería pacman. 

library("pacman") #la liberia para dummies. 

#Primero siempre cargamos librerias. La función p_load carga las librerias que ya tienes
#Y descarga e instala los paquetes que aún no tienes en tu maquina

p_load("dplyr",   #para el manejo de datos
       "ggplot2", #para los graficos
       "vroom",  #para leer datos facilmente
       "stringr", #para filtrar datos 
       "viridis")  #colores
...
#Una vez que hemos leído los datos, podemos visualizarlos en nuestra seccion de Data 
